...
/*
    ...
    1、创建（管理员）
    2、插入（传入数据）
    3、查询（根据学生id、课程id查询课程发布的作业详情列表）
    4、查询（根据学生id、课程id和作业次数查询发布的作业详情）
*/
contract HomeworkSubmit{
    ...
    constructor() public{
        ...
        "studentid,content,classid,classname,homeworknumber,uploadtime");
    }
